...
var Beckey = new StudentModel({ name: "Rapsody", age: 25});
var brandon = new StudentModel({ name: "Herbo", age: 25});
var steve = new StudentModel({ name: "Jhene", age: 25});
...
var students = [Beckey, brandon, steve];
